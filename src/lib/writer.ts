...
import type { CompilationItem, SourceType } from "../types.js";
...
export async function writeSourceMarkdown(
	...
	const dir = resolve(outputDir, source);
...
export async function writeSlackGranularOutput(
	...
	const slackDir = resolve(outputDir, "slack");
...
export async function writeGranolaGranularOutput(
	...
	const granolaDir = resolve(outputDir, "granola");
...
export async function writeFigmaGranularOutput(
	...
	const figmaDir = resolve(outputDir, "figma");
...
export async function writeGmailGranularOutput(
	...
	const gmailDir = resolve(outputDir, "gmail");
...
export async function writeCompiledMarkdown(
	...
	await Bun.write(resolve(outputDir, "_compiled.md"), header + body);
}
